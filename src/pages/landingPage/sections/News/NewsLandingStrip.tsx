            ...
            <div className="flex flex-col w-full">
                <section className="flex flex-col">
                    <div className="container space-y-8">
                        ...
                        >
                            <div className="w-1/2 h-80 pr-3 pl-3 rounded">
                                <img
                        ...
                        <div className="flex flex-row w-full items-center">
                            ...
                            />
                            <div className="grid justify-center grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3 mt-2">
...
export default NewsLandingStrip;
