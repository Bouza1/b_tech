...
const ProductPage = () => {
    const { productTable, productID } = useParams<{ productTable: string; productID: string }>();
    const {product, loading} = useFetchProduct(productTable as string, productID as string)
                            ...
                            <div className="flex flex-wrap mb-24 -mx-4">
                                ...
                                <div className="w-full px-4 md:w-1/2">
                                    <div className="lg:pl-20">
                                        <div className="mb-6 ">
                                            <span className="px-2.5 py-0.5 text-xs text-green-600 bg-green-100 ">
                                                New Arrival
                                            </span>
                                            <h2 className="max-w-xl mt-6 mb-6 text-xl font-semibold leading-loose tracking-wide text-gray-700 md:text-2xl">
                                                {' '}
                                                Intel® Core™ i5-12600HX Processor (18M Cache, up
                                                to 4.60 GHz){' '}
                                            </h2>
                                        ...
                                        <div
                                            className="py-6 mb-6 border-t border-b border-gray-200 dark:border-gray-700">
